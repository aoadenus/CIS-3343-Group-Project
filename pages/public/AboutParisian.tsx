...
/**
 * Parisian/European Aesthetic About Page
 * Dark mode design with elegant French bakery inspiration
 * Features: Eiffel Tower parallax, bokeh lights, gradient text, animated accents
 */
...
export function AboutParisian() {
  ...
  return (
    <div className="min-h-screen" style={{ background: '#2B2B2B' }}>
      ...
      {/* Our Values - Alternating Charcoal/Cream */}
